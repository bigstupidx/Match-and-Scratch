...
/// Solution based on:
/// <url>http://www.daniel4d.com/blog/sharing-image-unity-android/</url>
/// <url>http://www.thegamecontriver.com/2015/09/unity-share-post-image-to-facebook.html?showComment=1455523299779#c1485580557316768963</url>
public class ShareAndRate : MonoBehaviour
{

    [TextArea(1, 1)]
    public string subject = "Subject text";
    [TextArea(2, 4)]
    public string body = "Actual text (Link)";
